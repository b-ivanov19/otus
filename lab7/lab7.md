...
Fa0/2            Altn BLK 19        128.2    P2p
```
В качестве порта корневого моста на каждом коммутаторе некорневого моста протоколом STP выбраны порты fa0/1, так как данные порты имеют минимальный MAC-адрес, по сравнению с другими активными портами на коммутаторах S1 и S3.
