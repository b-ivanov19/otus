...
#### Исправление ошибок
В результате анализа и после тестирования было выявлено, что правило ACL SALES_OUT было применено на выход, а нужно его применить на вход интерфейса G0/0/1.40 маршрутизатора R1 для фильтрации входящего трафика из сети Sales
```
interface gigabitethernet 0/0/1.40
